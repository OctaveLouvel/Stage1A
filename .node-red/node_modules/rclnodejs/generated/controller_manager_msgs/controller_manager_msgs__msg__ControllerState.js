...
const ControllerStateRefStruct = StructType({
  ...
  is_async: primitiveTypes.bool,
  update_rate: primitiveTypes.uint16,
  ...
  exported_state_interfaces: StringWrapper.refObjectArrayType,
...
class ControllerStateWrapper {
  constructor(other) {
    ...
    this._setDefaults();
     if (typeof other === 'object' && other._refObject) {
      ...
      this._wrapperFields.exported_state_interfaces = StringWrapper.createArray();
      this._wrapperFields.exported_state_interfaces.copy(other._wrapperFields.exported_state_interfaces);
      this.exported_state_interfaces = other.exported_state_interfaces;
  ...
  _initialize() {
    ...
    this._wrapperFields.exported_state_interfaces = StringWrapper.createArray();
    this._exported_state_interfacesArray = [];
    this._wrapperFields.reference_interfaces = StringWrapper.createArray();
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.exported_state_interfaces.fill([]);
    } else {
      this._wrapperFields.exported_state_interfaces.fill(this._exported_state_interfacesArray);
    }
    this._wrapperFields.exported_state_interfaces.freeze(own);
    this._refObject.exported_state_interfaces = this._wrapperFields.exported_state_interfaces.refObject;
    if (own) {
  ...
  deserialize(refObject) {
    ...
    this._refObject.is_async = refObject.is_async;
    this._refObject.update_rate = refObject.update_rate;
    ...
    refObject.exported_state_interfaces.data.length = refObject.exported_state_interfaces.size;
    for (let index = 0; index < refObject.exported_state_interfaces.size; index++) {
      this._exported_state_interfacesArray[index] = refObject.exported_state_interfaces.data[index].data;
    }
  ...
  static freeStruct(refObject) {
    ...
    if (refObject.exported_state_interfaces.size != 0) {
      StringWrapper.ArrayType.freeArray(refObject.exported_state_interfaces);
      if (!StringWrapper.ArrayType.useTypedArray) {
        deallocator.freeStructMember(refObject.exported_state_interfaces, StringWrapper.refObjectArrayType, 'data');
      }
    }
  ...
  get is_async() {
    return this._refObject.is_async;
  }
  set is_async(value) {
    this._refObject.is_async = value;
  }
  get update_rate() {
    return this._refObject.update_rate;
  }
  set update_rate(value) {
    this._refObject.update_rate = value;
  }
  ...
  get exported_state_interfaces() {
    return this._exported_state_interfacesArray;
  }
  set exported_state_interfaces(value) {
    this._exported_state_interfacesArray = value;
  }
  ...
  copy(other) {
    ...
    this._exported_state_interfacesArray = other._exported_state_interfacesArray.slice();
